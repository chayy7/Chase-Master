...
export function RobotHero({
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full h-[500px] lg:h-[600px] overflow-hidden rounded-t-[3rem]"
    ...
    >
      ...
      {children && (
        <div className="absolute inset-x-0 bottom-0 z-20 pointer-events-none flex flex-col justify-end">
